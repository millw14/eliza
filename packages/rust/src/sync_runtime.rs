...
// Use tokio::sync::RwLock only for async native (non-wasm) builds.
#[cfg(all(not(feature = "sync"), feature = "native", not(feature = "wasm")))]
use tokio::sync::RwLock;

// Use std::sync::RwLock for sync mode, wasm, or non-native builds.
#[cfg(any(feature = "sync", not(feature = "native"), feature = "wasm"))]
use std::sync::RwLock;
